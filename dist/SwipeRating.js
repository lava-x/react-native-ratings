...
export default class SwipeRating extends Component {
    ...
    displayCurrentRating() {
        ...
        <View>
          {readonly && showReadOnlyText && (<Text style={[styles.readonlyLabel, { color }]}>(readonly)</Text>)}
        </View>
      </View>);
    }
    render() {
        ...
        return this.state.display ? (<View pointerEvents={readonly ? 'none' : 'auto'} style={style}>
